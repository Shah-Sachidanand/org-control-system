...
export const PromotionDashboard: React.FC = () => {
  ...
  const promotionTypes = [
    ...
    },
    {
      ...
      route: '/promotions/joining-bonus',
      ...
      <div>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {promotionTypes.map((type) => {
            const hasAccess = hasPermission('promotion', 'read', type.subFeature);
            const canWrite = hasPermission('promotion', 'write', type.subFeature);
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">Email Campaign "Summer Sale" launched</p>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">QR Code campaign reached 1,000 scans</p>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">Unique code batch generated</p>
