...
import { Star, CreditCard, PenTool, Trophy, Plus, Package } from "lucide-react";
    ...
    <div className="container mx-auto p-6 space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
        ...
        {hasPermission("merchandise", "write") && (
          <Button
            onClick={() => navigate("/merchandise/add")}
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Merchandise value</p>
          </CardContent>
        </Card>
      </div>
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">
                  New autograph items added to inventory
                </p>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">
                  Experience reward redeemed by customer
                </p>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex-1">
                <p className="text-sm font-medium">
                  Loaded value card batch created
                </p>
